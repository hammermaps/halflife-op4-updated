...
const unsigned int iDefaultBlood = 2;
const unsigned int iDefaultImpactWater = 3;
const unsigned int iDefaultHitFleshRed = 4;
const unsigned int iDefaultHitFleshYellow = 5;
const unsigned int iDefaultScorch = 6;
const unsigned int iDefaultParticle = 7;
const unsigned int iDefaultExplosionWater = 8;
const unsigned int iDefaultBloodRedPit = 9; //When monster is dead
const unsigned int iDefaultImpactGlass = 10; //Glass
const unsigned int iDefaultImpactGrass = 11; //Grass
const unsigned int iDefaultImpactCement = 12; //Cement
const unsigned int iDefaultImpactWood = 13; //Cement
const unsigned int iDefaultImpactBrown = 14; //Wall
const unsigned int iDefaultImpactSand = 15; //Sand ( beach sand")
const unsigned int iDefaultRocketTrail = 16; //Rocket Trail
