...
void CMP5::Precache()
{
	...
	m_usMP5 = PrecacheEvent("events/mp5.sc" );
	m_usMP52 = PrecacheEvent("events/mp52.sc" );
}
...
void CMP5::PrimaryAttack()
{
...
#endif
	{
		...
		vecDir = m_pPlayer->FireBulletsPlayer( 1, vecSrc, vecAiming, VECTOR_CONE_6DEGREES, 8192, BULLET_PLAYER_MP5, 2, m_pPlayer->pev, m_pPlayer->random_seed );
	}
	else
	{
		// single player spread
		vecDir = m_pPlayer->FireBulletsPlayer( 1, vecSrc, vecAiming, VECTOR_CONE_3DEGREES, 8192, BULLET_PLAYER_MP5, 2, m_pPlayer->pev, m_pPlayer->random_seed );
	}
